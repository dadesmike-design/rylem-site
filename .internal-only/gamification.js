...
const BADGES = {
  ...
  // Recruiter badges
  screen_machine:{ emoji: '🎙️', name: 'Screen Machine', desc: '20+ candidate screens in a week' },
  email_machine: { emoji: '📧', name: 'Email Machine',  desc: '50+ emails sent in a week' },
  cold_caller:   { emoji: '📞', name: 'Cold Caller',    desc: '25+ calls in a week' },
  matchmaker:    { emoji: '💘', name: 'Matchmaker',     desc: '5 submittals in a single day' },
  recruiter_mvp: { emoji: '🏅', name: 'Recruiter MVP',  desc: 'Top recruiter for the month' }
};
